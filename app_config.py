...
b2c_tenant = "xuejiedemo"
signupsignin_user_flow = "B2C_1_policy1"
...
CLIENT_ID = "da719a25-63fa-4094-bbea-a8e975c62cf4" # Application (client) ID of app registration

CLIENT_SECRET = "JzI7Q~KavznCt4VtyUld9b8aNIVfhfiKL54J9" # Placeholder - for use ONLY during testing.
...
SQLALCHEMY_DATABASE_URI = "sqlite:///example.sqlite" # set the url for the database to use